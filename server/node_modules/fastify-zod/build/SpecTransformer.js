...
class SpecTransformer {
  ...
  createSchemaKey = (parentSchemaKey, path, schemaKeysOptions) => {
    ...
    if (!(schemaKeysOptions !== null && schemaKeysOptions !== void 0 && schemaKeysOptions.removeInitialSchemasPrefix) || !this.initialSchemaKeys.includes(parentSchemaKey)) {
      parts.push(parentSchemaKey);
    }

    parts.push(...path);
    const baseName = parts.join(`_`);
    const schemaKey = (schemaKeysOptions === null || schemaKeysOptions === void 0 ? void 0 : schemaKeysOptions.changeCase) === `PascalCase` ? (0, _changeCase.pascalCase)(baseName) : (schemaKeysOptions === null || schemaKeysOptions === void 0 ? void 0 : schemaKeysOptions.changeCase) === `camelCase` ? (0, _changeCase.camelCase)(baseName) : (schemaKeysOptions === null || schemaKeysOptions === void 0 ? void 0 : schemaKeysOptions.changeCase) === `param-case` ? (0, _changeCase.paramCase)(baseName) : (schemaKeysOptions === null || schemaKeysOptions === void 0 ? void 0 : schemaKeysOptions.changeCase) === `snake_case` ? (0, _changeCase.snakeCase)(baseName) : baseName;
